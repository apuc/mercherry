      ...
      <div class="modal-content">
        <form>
          <div class="modal-body text-center pb-0">
            <p class="c-black font-weight-bold lh-1_2">
            ...
            <div class="form-group mb-1">
              <label class="control-label c-dark-gray text-transform-none">
                Вы уверены что вам будет удобно работать на территории?
                <span class="d-block  my-1">(Москва)</span>
              </label>
              <div>
                <label class="radio mr-2 c-dark-gray text-transform-none">
                  <input type="radio" name="ResponseForm[q0]" value="1">
                  <span class="radio__circle"></span>
                  <span>Да</span>
                </label>
                <label class="radio c-dark-gray text-transform-none">
